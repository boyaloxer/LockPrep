...
do
    ...
    -- Source TGA is 1024x1024. Bias crop slightly upward when trimming height.
    local SRC_W, SRC_H = 1024, 1024
    local function FitOptionsArt()
        ...
        if panelAspect > imgAspect then
            ...
            -- Keep more of the top than the bottom.
            v0 = slack * 0.18
            v1 = v0 + (visH / SRC_H)
